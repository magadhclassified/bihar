...
<?php include 'code/includes/member_motors_list.php';?>
<!DOCTYPE html>
<html lang="en">
  <head>
  <title>My Motors : My Dashboard : <?php echo COMPANY_NAME; ?></title> 
    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9 page-content">
            <div class="inner-box">
              <h2 class="title-2"><i class="fa fa-credit-card"></i> My Automobiles <a class="btn btn-danger btn-post" href="/my-motors-manage"><span class="fa fa-plus-circle"></span> Add new Motor<div class="ripple-container"></div></a></h2>
              <div class="table-responsive">
			  <?php $filter_options = array('MOTORS', 'Motor', 'my-motors-manage', 900, 950); include 'code/modules/members_manage_filter.php'; ?>
