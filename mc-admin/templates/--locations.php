<?php if(!isset($is_caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/locations_info.php'; ?><?php include 'code/includes/locations_list.php'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo SYSTEM_NAME; ?>: Listings: Locations</title>
...
<div class="section"><div class="title_wrapper"><h2>Locations</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
<p>Manage your locations below. To add a new top-level location, please click the ADD NEW button below. You may add a child location to another location below by clicking on the green plus icon.
<br /><br />
<a href="locations/add-0" class="button add_new"><span><span>ADD NEW</span></span></a><br />
...
<form action="code/includes/locations_manage.php" class="search_form general_form" method="post" id="webdev_form" onsubmit="return check_form(this, ['title'], ['TEXT']);">
<fieldset>
<div class="forms">
...
<ul><li><span class="button send_form_btn"><span><span>SAVE</span></span>
<input type="hidden" name="id" value="<?php echo $listing_id; ?>" />
<input type="hidden" name="pid" value="<?php echo $item_parent_id; ?>" />
