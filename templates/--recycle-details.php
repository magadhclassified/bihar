...
<?php include 'code/includes/recycle_info.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="product-info">
            <div class="col-sm-8">
              <div class="inner-box ads-details-wrapper">
                <h2><?php echo $field_title; ?> - <?php echo $field_type; ?></h2>
                <p class="item-intro"><span class="poster">Posted  <?php if(strlen($field_contact_name) > 0){ ?>  by <span class="ui-bubble is-member"><?php echo $field_contact_name ;?></span><?php } ?> on <span class="date"> <?php echo date('d M, Y',$field_date);?></span></span></p>
				...
				<div class="item">
                       <img src="files/recycle/medium/<?php echo $field_img1; ?>" alt="" rel="files/recycle/small/<?php echo $field_img1; ?>" />
				</div>
				</div>
				<?php } ?>
				...
				<div class="owl-item" style="width: 688px;">
				<div class="item">
                       <img src="files/recycle/medium/<?php echo $field_img2; ?>" alt="" rel="files/recycle/small/<?php echo $field_img2; ?>" />
				</div>
				</div>
				<?php } ?>
				...
				<div class="owl-item" style="width: 688px;">
				<div class="item">
                       <img src="files/recycle/medium/<?php echo $field_img3; ?>" alt="" rel="files/recycle/small/<?php echo $field_img3; ?>" />
				</div>
				</div>
				<?php } ?>
				...
				<div class="owl-item" style="width: 688px;">
				<div class="item">
                       <img src="files/recycle/medium/<?php echo $field_img4; ?>" alt="" rel="files/recycle/small/<?php echo $field_img4; ?>" />
				</div>
				</div>
				<?php } ?>
                ...
                <h2 class="title-2"><strong>Ads Details</strong></h2>
                  ...
                  <div class="col-md-4">
                    ...
                    <aside class="panel panel-body panel-details">
					  ...
					  <li>
					  <p class=" no-margin "><strong>Price:</strong><?php echo $global_settings_measurements[0] . ' ' . number_f2($field_price); ?></p>
					  </li>
					  <li>
						<p class=" no-margin "><strong>Condition:</strong><?php echo $field_condition; ?></p>
					  </li>
					  <?php if(strlen($field_location) > 0){ ?>
					   <li>
					  <p class=" no-margin "><strong>Location:</strong><?php echo $field_location; ?>
					   </li>
					  <?php } ?>
