...
//<![CDATA[
	tinyMCE.init({
		...
		theme_advanced_buttons1 : "bold,italic,separator,bullist,numlist,separator,cut,copy,paste,pasteword,removeformat,separator,undo,redo,separator,link,unlink,image,separator,charmap,code,separator,formatselect,styleselect,separator,spellchecker",
...
<textarea id="elm1" name="elm1" style="width:645px;height:300px" rows="25" cols="20">
<?php if(isset($html_text)){echo $html_text;} ?>
</textarea>