                  ...
                  <div class="col-md-3 col-sm-6 search-col">
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select">
						...
						<select class="dropdown-product selectpicker" name="xcuisine" tabindex="-98">
                          <option value="0">&nbsp;Show all Cuisines</option><?php echo $restaurants_cuisines_list; ?>
                        </select></div>                                    
                      </label>
                    </div>
                  </div>
                  <div class="col-md-3 col-sm-6 search-col">
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select location-select">
						...
						<select class="dropdown-product selectpicker" name="xmenu" tabindex="-98">
                          <option value="0">&nbsp;Show all Menus</option><?php echo $restaurants_menus_list; ?>
                        </select></div>                                    
                      </label>
                    </div>
                  </div>
                    ...
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select location-select">
						...
						<select class="dropdown-product selectpicker" name="xdresscode" tabindex="-98">
                          <option value="0">&nbsp; Show all Dress Codes</option><?php echo $restaurants_dresscode_list; ?>
                        </select></div>                                    
                      </label>
                    </div>
                  </div>
                  <div class="col-md-3 col-sm-6 search-col">
                    <div class="form-group is-empty"><input class="form-control keyword" name="kw" value="<?php if(strlen($search_data_x_kw) > 0){echo $search_data_x_kw;}else{echo 'Type your search...';} ?>" onfocus="if(this.value=='Type your search...'){this.value='';}" onblur="if(this.value==''){this.value='Type your search...';}" type="text"><span class="material-input"></span>
					<input type="hidden" name="origin" value="RESTAURANTS" />
					</div>
