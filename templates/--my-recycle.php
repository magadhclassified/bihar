...
<?php include 'code/includes/member_recycle_list.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9 page-content">
            <div class="inner-box">
              <h2 class="title-2"><i class="fa fa-credit-card"></i> My Recycle <a class="btn btn-danger btn-post" href="/my-recycle-manage"><span class="fa fa-plus-circle"></span> Add new Recycle<div class="ripple-container"></div></a></h2>
              <div class="table-responsive">
			  <?php $filter_options = array('RECYCLE', 'Ad', 'my-recycle-manage', 900, 950); include 'code/modules/members_manage_filter.php'; ?>
