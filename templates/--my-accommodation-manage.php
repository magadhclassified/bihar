<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/member_accommodation_info.php'; ?><!DOCTYPE html>
<html lang="en">
  <head>
  <title>My Hotels: My Dashboard: <?php echo COMPANY_NAME; ?></title>
              ...
              <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseB1"> Post Your Hotel </a> </h4>
                  </div>
                  <div id="collapseB1" class="panel-collapse collapse in">
                    <div class="panel-body">
					
					<form method="post" action="code/includes/member_accommodation_manage.php" enctype="multipart/form-data" 
					onsubmit="return check_form(this, ['title', 'type', 'rating', 'price', 'geo1', 'geo2', 'contact_name', 'contact_number', 'contact_email'], 
					['TEXT', 'LISTBOX', 'LISTBOX', 'TEXT', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'EMAIL']);">
					...
					<input placeholder="Title" class="form-control" type="text" name="title" value="<?php echo $item_title; ?>" />
						...
						<div class="form-group is-empty">
                         ...
                         <select name="rating" class="form-control"><option value="0">&nbsp;Please Select...</option><?php echo $ratings_listbox; ?></select>
                        <span class="material-input"></span></div>
						
						<div class="form-group is-empty">
                          <label class="control-label">Airport Distance</label>
						  <input class="form-control" type="text" placeholder="Airport Distance" name="distance" value="<?php echo $item_distance; ?>" />
						  <small>Distance from airport</small>
                        <span class="material-input"></span></div>
					 ...
					 <div class="form-group is-empty">
						  ...
						  <textarea data-error="Write your message" name="content_full" id="feedback-message" rows="9" placeholder="Accommodation Info" class="form-control"><?php echo $item_contents; ?></textarea>
                       ...
                       <select name="facility[]" multiple="multiple" size="10" class="form-control"><?php echo $facilities_list; ?></select>
						...
						<?php if(strlen($item_image_file1) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/accommodation/medium/<?php echo $item_image_file1; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div></div>
                        ...
                        <div class="ripple-container"></div>
						<?php if(strlen($item_image_file2) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/accommodation/medium/<?php echo $item_image_file2; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div>
						</div>
                        ...
                        <div class="ripple-container"></div>
						<?php if(strlen($item_image_file3) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/accommodation/medium/<?php echo $item_image_file3; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div>
						</div>
                        ...
                        <div class="ripple-container"></div>
						<?php if(strlen($item_image_file4) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/accommodation/medium/<?php echo $item_image_file4; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div>
						</div>
