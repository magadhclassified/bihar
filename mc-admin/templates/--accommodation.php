<?php if(!isset($is_caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/accommodation_info.php'; ?><?php include 'code/includes/accommodation_list.php'; ?><?php include 'code/includes/accommodation_search_fields.php'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo SYSTEM_NAME; ?>: Listings: Accommodation</title>
...
<div class="section"><div class="title_wrapper"><h2>Accommodation</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
...
<?php }} ?>
<p>Manage your accommodation listings below. To add a new listing, please click the ADD NEW button below.<br /><br />
<a href="accommodation/add" class="button add_new"><span><span>ADD NEW</span></span></a><br />
</p>																															
...
<div class="section"><div class="title_wrapper"><h2>Search Accommodation</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
<table style="width:660px;border:0px;" cellspacing="2" cellpadding="2">
  ...
  <td>&nbsp;</td>
  <td style="text-align:right;padding-right:13px;"><input type="hidden" name="origin" value="ACCOMMODATION" /><input type="submit" value="Search" /></td>
  </tr>
</table>																															
</div></div></div></div></div><span class="scb"><span class="scb_left"></span><span class="scb_right"></span></span></div></div>
</form>
...
<h2>Accommodation<?php echo $result_title_append; ?></h2>
...
<div class="section table_section"><div class="title_wrapper"><h2>Accommodation<?php echo $result_title_append; ?></h2>
<span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">							<div  id="product_list"><div class="table_wrapper"><div class="table_wrapper_inner">
...
<?php if($listing_form){ ?>
<form action="code/includes/accommodation_manage.php" class="search_form general_form" method="post" enctype="multipart/form-data" id="webdev_form" onsubmit="return check_form(this, ['title', 'type', 'rating', 'geo1', 'geo2', 'member', 'contact_name', 'contact_number', 'contact_email'], ['TEXT', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'EMAIL']);">
<div class="section">
...
<div class="row"><label>Rating:</label><div class="inputs"><span class="input_wrapper blank">
<select name="rating">
<option value="0">Please Select...</option>
<?php echo $ratings_listbox; ?>
</select></span></div></div>
<div class="row"><label>Airport Distance:</label>
<div class="inputs"><span class="input_wrapper"><input class="text" name="airport" type="text" value="<?php echo $item_fromairport; ?>" /></span><span class="system neutral">Distance from airport</span>														
</div></div>	
<div class="row"><label>Pricing:</label>
<div class="inputs"><span class="input_wrapper"><input class="text" name="price" type="text" value="<?php echo $item_price; ?>" /></span>														
</div></div>	
...
<textarea rows="" cols="" name="address" class="text"><?php echo $item_address; ?></textarea>
</span>
</div>
</div>
...
<div class="inputs"><span class="input_wrapper blank"><input name="frm_upload1" type="file" /></span><?php if(strlen($item_image_file1) > 0){ ?><span class="system">&nbsp;&nbsp;&nbsp;[<a href="../files/accommodation/medium/<?php echo $item_image_file1; ?>" onclick="return!window.open(this.href);" title="header=[Preview] body=[&lt;img src='../files/accommodation/thumb/<?php echo $item_image_file1; ?>' alt='' title='' /&gt;]">Current</a>]</span><?php } ?></div>
</div>
<div class="row"><label>Image #2:</label>
<div class="inputs"><span class="input_wrapper blank"><input name="frm_upload2" type="file" /></span><?php if(strlen($item_image_file2) > 0){ ?><span class="system">&nbsp;&nbsp;&nbsp;[<a href="../files/accommodation/medium/<?php echo $item_image_file2; ?>" onclick="return!window.open(this.href);" title="header=[Preview] body=[&lt;img src='../files/accommodation/thumb/<?php echo $item_image_file2; ?>' alt='' title='' /&gt;]">Current</a>]</span><?php } ?></div>
</div>
<div class="row"><label>Image #3:</label>
<div class="inputs"><span class="input_wrapper blank"><input name="frm_upload3" type="file" /></span><?php if(strlen($item_image_file3) > 0){ ?><span class="system">&nbsp;&nbsp;&nbsp;[<a href="../files/accommodation/medium/<?php echo $item_image_file3; ?>" onclick="return!window.open(this.href);" title="header=[Preview] body=[&lt;img src='../files/accommodation/thumb/<?php echo $item_image_file3; ?>' alt='' title='' /&gt;]">Current</a>]</span><?php } ?></div>
</div>
<div class="row"><label>Image #4:</label>
<div class="inputs"><span class="input_wrapper blank"><input name="frm_upload4" type="file" /></span><?php if(strlen($item_image_file4) > 0){ ?><span class="system">&nbsp;&nbsp;&nbsp;[<a href="../files/accommodation/medium/<?php echo $item_image_file4; ?>" onclick="return!window.open(this.href);" title="header=[Preview] body=[&lt;img src='../files/accommodation/thumb/<?php echo $item_image_file4; ?>' alt='' title='' /&gt;]">Current</a>]</span><?php } ?></div>
</div>
