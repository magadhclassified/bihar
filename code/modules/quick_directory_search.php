              ...
              <div class="advanced-search">
                <form class="search-form" method="post" action="code/includes/search_proxy.php">
                    ...
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select">
						...
						<select class="dropdown-product selectpicker" name="pcategory" tabindex="-98">
                          <option value="0">&nbsp;Show all Categories</option><?php echo $directory_categories_list; ?>
                        </select></div>                                    
                      </label>
                    </div>
                  </div>
                  <div class="col-md-3 col-sm-6 search-col">
					...
					<input class="form-control keyword" name="kw" value="<?php if(strlen($search_data_d_kw) > 0){echo $search_data_d_kw;}else{echo 'Type your search...';} ?>" onfocus="if(this.value=='Type your search...'){this.value='';}" onblur="if(this.value==''){this.value='Type your search...';}" type="text"><span class="material-input"></span>
