...
function defHdrStyle() {
	...
	dvHdr.style.border='1px solid #6a97a7';
	dvHdr.style.padding='3px';
	dvHdr.style.fontSize='12px';
	dvHdr.style.color='#FFFFFF';
	dvHdr.style.background='#6a97a7';
	dvHdr.style.filter='alpha(opacity=100)'; // IE
	dvHdr.style.opacity='1'; // FF
}

function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #6a97a7';
	dvBdy.style.borderLeft='1px solid #6a97a7';
	dvBdy.style.borderRight='1px solid #6a97a7';
