<?php if(!isset($is_caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/events_info.php'; ?><?php include 'code/includes/events_list.php'; ?><?php include 'code/includes/events_search_fields.php'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo SYSTEM_NAME; ?>: Listings: Events</title>
...
<div class="section"><div class="title_wrapper"><h2>Events</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
...
<?php }} ?>
<p>Manage your events below. To add a new event, please click the ADD NEW button below.<br /><br />
<a href="events/add" class="button add_new"><span><span>ADD NEW</span></span></a><br />
</p>																															
...
<div class="section"><div class="title_wrapper"><h2>Search Events</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
<table style="width:660px;border:0px;" cellspacing="2" cellpadding="2">
  ...
  <td>&nbsp;</td>
  <td style="text-align:right;padding-right:13px;"><input type="hidden" name="origin" value="EVENTS" /><input type="submit" value="Search" /></td>
  </tr>
</table>																															
</div></div></div></div></div><span class="scb"><span class="scb_left"></span><span class="scb_right"></span></span></div></div>
</form>
...
<h2>Events<?php echo $result_title_append; ?></h2>
...
<div class="section table_section"><div class="title_wrapper"><h2>Events<?php echo $result_title_append; ?></h2>
<span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">							<div  id="product_list"><div class="table_wrapper"><div class="table_wrapper_inner">
...
<?php if($listing_form){ ?>
<form action="code/includes/events_manage.php" class="search_form general_form" method="post" enctype="multipart/form-data" id="webdev_form" onsubmit="return check_form(this, ['title', 'type', 'geo1', 'geo2', 'member', 'contact_name', 'contact_number', 'contact_email'], ['TEXT', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'EMAIL']);">
<div class="section">
...
<div class="row"><label>Venue:</label>
<div class="inputs"><span class="input_wrapper"><input class="text" name="venue" type="text" value="<?php echo $item_venue; ?>" /></span>														
</div></div>	
<div class="row"><label>Times:</label>
<div class="inputs"><span class="input_wrapper"><input class="text" name="times" type="text" value="<?php echo $item_times; ?>" /></span><span class="system neutral">E.g. open daily 9am - late</span>													
</div></div>	

<div class="row"><label>Entry Fee:</label>
...
<div class="row"><label>Event Website:</label>
<div class="inputs"><span class="input_wrapper"><input class="text" name="contact_web" type="text" value="<?php echo $item_website; ?>" /></span>											
</div></div>	
...
<div class="inputs"><span class="input_wrapper blank"><input name="frm_upload1" type="file" /></span><?php if(strlen($item_image_file1) > 0){ ?><span class="system">&nbsp;&nbsp;&nbsp;[<a href="../files/events/medium/<?php echo $item_image_file1; ?>" onclick="return!window.open(this.href);" title="header=[Preview] body=[&lt;img src='../files/events/thumb/<?php echo $item_image_file1; ?>' alt='' title='' /&gt;]">Current</a>]</span><?php } ?></div>
</div>
