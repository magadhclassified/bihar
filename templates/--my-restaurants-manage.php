<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/member_restaurants_info.php'; ?><!DOCTYPE html>
<html lang="en">
  <head>
  <title>My Restaurant: My Dashboard: <?php echo COMPANY_NAME; ?></title>
              ...
              <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseB1"> Post Your Restaurant </a> </h4>
                  </div>
                  <div id="collapseB1" class="panel-collapse collapse in">
                    <div class="panel-body">
					<form method="post" action="code/includes/member_restaurants_manage.php" enctype="multipart/form-data" 
onsubmit="return check_form(this, ['title', 'menu', 'dresscode', 'price', 'geo1', 'geo2', 'contact_name', 'contact_number', 'contact_email'], 
['TEXT', 'LISTBOX', 'LISTBOX', 'TEXT', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'EMAIL']);">
					...
					<input placeholder="Title" class="form-control" type="text" name="title" value="<?php echo $item_title; ?>" />
                        ...
                        <div class="form-group is-empty">
						  ...
						  <select name="menu" class="form-control"><option value="0">&nbsp;Please Select...</option><?php echo $menus_listbox; ?></select>
						
                        <span class="material-input"></span></div>
                        <div class="form-group is-empty">
                          <label class="control-label">Dress Code:</label>
                        <select name="dresscode" class="form-control"><option value="0">&nbsp;Please Select...</option><?php echo $dresscodes_listbox; ?></select>
                        <span class="material-input"></span></div>
                        <div class="form-group is-empty">
					 ...
					 <div class="form-group is-empty">
						...
						<div class="form-group is-empty">
                          <label class="control-label">Cuisine(s)</label>
                        <select name="cuisine[]" multiple="multiple" size="10" class="form-control"><?php echo $cuisines_list; ?></select>
