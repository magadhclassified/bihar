<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/jobs_info.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="product-info">
            <div class="col-sm-8">
              <div class="inner-box ads-details-wrapper">
				...
				<div class="item">
                       <img src="files/jobs/medium/<?php echo $field_img; ?>" alt="" rel="files/jobs/small/<?php echo $field_img1; ?>" />
				</div>
				</div>
				<?php } ?>
				</div>
              ...
              <div class="Ads-Details">
                <h2 class="title-2"><strong>Ads Detsils</strong></h2>
                  ...
                  <div class="col-md-4">
                    <aside class="panel panel-body panel-details">
                      <ul>
					  <?php if(strlen($field_salary) > 0){ ?>
                        <li>
                        <p class=" no-margin "><strong>Salary:</strong> <?php echo $field_salary; ?></p>
                        </li><?php } ?>
						<?php if(strlen($field_location) > 0){ ?>
                        <li>
                        <p class="no-margin"><strong>Location:</strong> <?php echo $field_location; ?></p>
                        </li><?php } ?>
						<?php if(strlen($field_commitment) > 0){ ?>
						<li>
                        <p class="no-margin"><strong>Job Type:</strong> <?php echo $field_commitment; ?></p>
                        </li><?php } ?>
						<?php if(strlen($field_ref) > 0){ ?>
						<li>
                ...
                <h2 class="title-2"><strong>Enquire about this Job</strong></h2>
                  <div class="row">
...
<div id="googlemap" style="width: 720px; height: 300px;"></div>
<?php }else{ ?>
<img class="eventmap" src="files/jobs/medium/<?php echo $field_img; ?>" alt="<?php echo safe_alt($field_title); ?>" title="<?php echo safe_alt($field_title); ?>" />
<?php }  ?>
	 </div>
              </div>
            </div>
