<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/member_motors_info.php'; ?><!DOCTYPE html>
<html lang="en">
  <head>
  <title>My Motor: My Dashboard: <?php echo COMPANY_NAME; ?></title>
              ...
              <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseB1"> Post Your Motors </a> </h4>
                  </div>
                  <div id="collapseB1" class="panel-collapse collapse in">
                    <div class="panel-body">
					
					<form method="post" action="code/includes/member_motors_manage.php" enctype="multipart/form-data" onsubmit="return check_form(this, ['title', 'price', 'doors', 'mileage', 'year', 'mm', 'colour', 'type', 'geo1', 'geo2', 'contact_name', 'contact_number', 'contact_email'], ['TEXT', 'TEXT', 'TEXT', 'TEXT', 'TEXT', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'EMAIL']);">
					...
					<input placeholder="Title" class="form-control" type="text" name="title" value="<?php echo $item_title; ?>" />
                        ...
                        <span class="material-input"></span></div>
						 ...
						 <div class="form-group is-empty">
						  ...
						  <input class="form-control" type="text" placeholder="Doors" name="doors" value="<?php echo $item_doors; ?>" />
						  <small>Numeric value only, e.g. 4</small>
                        <span class="material-input"></span></div>
						
						
						 <div class="form-group is-empty">
                          <label class="control-label">Mileage (km)</label>
						  <input class="form-control" type="text" placeholder="Mileage (km)" name="mileage" value="<?php echo $item_mileage; ?>" />
						  <small>Numeric value only, e.g. 50000</small>
                        <span class="material-input"></span></div>
						
						
						 <div class="form-group is-empty">
                          <label class="control-label">Vehicle Year</label>
						  <input class="form-control" type="text" placeholder="Vehicle Year" name="year" value="<?php echo $item_year; ?>" />
						  <small>Numeric value only, e.g. <?php echo date('Y'); ?></small>
                        <span class="material-input"></span></div>
						
                        <div class="form-group is-empty">
                          <label class="control-label">Make & Model:</label>
                         <select name="mm" class="form-control"><option value="0">&nbsp;Please Select...</option><?php echo $mm_listbox; ?></select>
                        <span class="material-input"></span></div>
                     
                        <div class="form-group is-empty">
                          <label class="control-label" for="Phone">Colour</label>
						 <select name="colour" class="form-control"><option value="0">&nbsp;Please Select...</option><?php echo $colours_listbox; ?></select>
                        <span class="material-input"></span></div>					
					 ...
					 <div class="form-group is-empty">
						  ...
						  <textarea data-error="Write your message" name="content_full" id="feedback-message" rows="9" placeholder="Property Info" class="form-control"><?php echo $item_contents; ?></textarea>
						...
						<?php if(strlen($item_image_file1) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/motors/medium/<?php echo $item_image_file1; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div></div>
                        ...
                        <div class="ripple-container"></div>
						<?php if(strlen($item_image_file2) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/motors/medium/<?php echo $item_image_file2; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div>
						</div>
                        ...
                        <div class="ripple-container"></div>
						<?php if(strlen($item_image_file3) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/motors/medium/<?php echo $item_image_file3; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div>
						</div>
                        ...
                        <div class="ripple-container"></div>
						<?php if(strlen($item_image_file4) > 0){ ?><p class="poplabel2">&nbsp;</p><p class="normalfield"><a href="files/motors/medium/<?php echo $item_image_file4; ?>" onclick="return!window.open(this.href);">Current Image</a></p><?php } ?>
						</div>
						</div>
