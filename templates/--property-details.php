<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/property_info.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div id="content">
     <div class="container">
        <div class="row">
          ...
          <div class="product-info">
            <div class="col-sm-8">
              <div class="inner-box ads-details-wrapper">
                ...
                <p class="item-intro"><span class="poster">For <?php echo $field_category;?>  <?php if(strlen($field_contact_name) > 0){ ?>  by <span class="ui-bubble is-member"><?php echo $field_contact_name ;?></span><?php } ?> on <span class="date"> <?php echo date('d M, Y',$field_date);?></span> <?php if(strlen($field_profile_address) > 0){ ?>from <span class="location"><?php echo $field_profile_address;?></span><?php } ?></span></p>
          ...
          <?php if(strlen($features_list) > 0 || strlen($views_list) > 0){echo '<br />&nbsp;<br />';} ?>
          <?php if(strlen($features_list) > 0){ ?>
          <span class="blue">Features and Amenities</span><br />
          <br />
          <?php echo $features_list; } ?>
          <?php if(strlen($views_list) > 0 && strlen($features_list) > 0){echo '&nbsp;<br />';} ?>
          <?php if(strlen($views_list) > 0){ ?>
          <span class="blue">Views</span><br />
          <br />
          <?php echo $views_list; } ?> </p>
                  ...
                  <div class="col-md-4">
                    <aside class="panel panel-body panel-details">
                      <ul>
                        <li>
                        <p class=" no-margin "><strong>Price:</strong> <?php echo $global_settings_measurements[0] . ' ' . number_f($field_price) . ' ' . $field_rental_time; ?></p>
                        </li>
                        <li>
                        <p class="no-margin"><strong>Type:</strong> <?php echo $field_type;?></a>, For <?php echo $field_category;?></p>
                        </li>
                        <li>
                        <p class="no-margin"><strong>Location:</strong> <?php echo $field_emirate . ', ' . $field_location; ?></p>
                        </li>
						<li>
                        <p class="no-margin"><strong>Development:</strong> <?php echo $field_development; ?></p>
                        </li>
						<li>
                        <p class="no-margin"><strong>Approx size:</strong> <?php echo $field_size . ' ' . $global_settings_measurements[2]; ?></p>
                        </li>
						<li>
                        <p class="no-margin"><strong>Bedroom:</strong> <?php echo number_f($field_bed); ?></p>
                        </li>
						<li>
                        <p class="no-margin"><strong>Bathroom:</strong> <?php echo number_f($field_bath); ?></p>
                        </li>
                        <?php if(strlen($field_no_cheques) > 0){ ?>
						<li>
                        <p class=" no-margin "><strong>No. of Cheques:</strong> <?php echo $field_no_cheques; ?></p>
                        </li>
          
                       <?php } ?>
		              <li>
                        <p class=" no-margin "><strong>Reference #:</strong> <?php echo $field_ref; ?></p>
                        </li>
			  ...
			  <div class="Ads-Details" id="contactFormDiv">
                <h2 class="title-2"><strong>Enquire about this Property</strong></h2>
                  <div class="row">
...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&amp;key=<?php echo $global_info[2]; ?>"></script>
