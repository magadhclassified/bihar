                  ...
                  <div class="col-md-3 col-sm-6 search-col">
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select">
						...
						<select class="dropdown-product selectpicker" name="rcategory" tabindex="-98">
                          <option value="0">&nbsp;Show all Categories</option><?php echo $recycle_categories_list; ?>
                        </select></div>                                    
                      </label>
                    </div>
                  </div>
                    ...
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select location-select">
						...
						<select class="dropdown-product selectpicker" name="rcondition" tabindex="-98">
                          <option value="0">&nbsp;Show all Conditions</option><?php echo $recycle_conditions_list; ?>
                        </select></div>                                    
                      </label>
                    </div>
                  </div>
				  <div class="col-md-3 col-sm-6 search-col">
                    <div class="input-group-addon search-category-container">
                      <label class="styled-select location-select">
						...
						<select class="dropdown-product selectpicker" name="rtype" tabindex="-98">
                          <option value="0">&nbsp;Show all Types</option><?php echo $recycle_types_list; ?>
                        </select></div>                                    
                      </label>
                    </div>
                  </div>
                  <div class="col-md-3 col-sm-6 search-col">
                    <div class="form-group is-empty"><input class="form-control keyword" name="kw" value="<?php if(strlen($search_data_r_kw) > 0){echo $search_data_r_kw;}else{echo 'Type your search...';} ?>" onfocus="if(this.value=='Type your search...'){this.value='';}" onblur="if(this.value==''){this.value='Type your search...';}" type="text"><span class="material-input"></span>
					<input type="hidden" name="origin" value="RECYCLE" />
					</div>
