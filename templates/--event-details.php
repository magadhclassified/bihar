...
<?php include 'code/includes/events_info.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
                ...
                <h2 class="title-2"><strong>Ads Details</strong></h2>
                  ...
                  <div class="col-md-4">
                    ...
                    <aside class="panel panel-body panel-details">
					  ...
					  <li>
					  <p class=" no-margin "><strong>Date:</strong><?php echo $event_string_feat; ?></p>
					  </li>
					  <li>
						<p class=" no-margin "><strong>Location:</strong><?php echo $field_location; ?></p>
					  </li>
					  <?php if(strlen($field_venue) > 0){ ?>
					   <li>
					  <p class=" no-margin "><strong>Venue:</strong><?php echo $field_venue; ?>
					   </li>
					  <?php } ?>
					   <?php if(strlen($field_price) > 0){ ?>
                        <li>
                        <p class=" no-margin "><strong>Entry Fee:</strong> <?php echo $field_price; ?></p>
                        </li>
					   <?php } ?>
					   
					    <?php if(strlen($field_type) > 0){ ?>
                        <li>
                        <p class=" no-margin "><strong>Type:</strong> <?php echo $field_type; ?></p>
                        </li>
					   <?php } ?>
					   
					   <?php if(strlen($field_times) > 0){ ?>
					    <li>
					   <p class="no-margin"><strong>Opening Hours:</strong><?php echo $field_times; ?></p>  
					    </li>
					   <?php } ?>
					   
						<?php if(strlen($field_web) > 0){ ?>
						 <li>
						<p class="no-margin"><strong>Website:<a href="<?php echo test_link($field_web); ?>" rel="nofollow" onclick="return!window.open(this.href);"><?php echo chop_text($field_web, 20, '.', '...'); ?></a></p>
						 </li>
						<?php } ?>
