    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9 page-content">
            <div class="inner-box">
              <h2 class="title-2"><i class="fa fa-credit-card"></i> My Directory <a class="btn btn-danger btn-post" href="/my-directory-manage"><span class="fa fa-plus-circle"></span> Add new Directory Entry<div class="ripple-container"></div></a></h2>
              <div class="table-responsive">
			  
			  <?php $filter_options = array('DIRECTORY', 'Directory', 'my-directory-manage', 900, 950); include 'code/modules/members_manage_filter.php'; ?>
