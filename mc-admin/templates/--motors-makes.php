<?php if(!isset($is_caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/motors_makes_info.php'; ?><?php include 'code/includes/motors_makes_list.php'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo SYSTEM_NAME; ?>: Listings: Motors: Makes &amp; Models</title>
...
<div class="section"><div class="title_wrapper"><h2>Makes &amp; Models</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
...
<?php }} ?>
<p>Manage your current makes and models below. To add a new make, please click the ADD NEW button below. So add a model, click the green + icon next to the make in question. <br /><br />
<a href="motors-makes/add-0" class="button add_new"><span><span>ADD NEW</span></span></a><br />
</p>																															
...
<form action="code/includes/motors_makes_manage.php" class="search_form general_form" method="post" id="webdev_form" onsubmit="return check_form(this, ['title'], ['TEXT']);">
<fieldset>
<div class="forms">
