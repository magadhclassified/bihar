<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/accommodation_list.php'; ?><?php include 'code/includes/accommodation_featured.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div id="search-row-wrapper">
      <div class="container">
        <div class="search-inner">
            <!-- Start Search box -->
             <?php include 'code/modules/quick_accommodation_search.php'; ?>
            <!-- End Search box -->
        </div>
      </div>
    </div>
