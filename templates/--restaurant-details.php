...
<?php include 'code/includes/restaurants_info.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="product-info">
            <div class="col-sm-8">
                  ...
                  <div class="col-md-4">
                    ...
                    <aside class="panel panel-body panel-details">
					  ...
					  <?php } ?>
						...
						<li>
                        <p class="no-margin"><strong>Menu:</strong> <?php echo $field_menu; ?></p>
                        </li>
						<li>
                        <p class="no-margin"><strong>Dress Code:</strong> <?php echo $field_dresscode; ?></p>
                        </li>
						
						<?php if(strlen($cuisines_list) > 0){ ?>
						<li>
                        <p class="no-margin"><strong>Cuisine(s):</strong> <?php echo $cuisines_list; ?></p>
                        </li>
						<?php } ?>
			  ...
			  <div class="Ads-Details" id="contactFormDiv">
                <h2 class="title-2"><strong>Enquire about this Restaurant</strong></h2>
                  <div class="row">
