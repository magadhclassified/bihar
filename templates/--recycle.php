...
<?php include 'code/includes/recycle_list.php'; ?>
<?php include 'code/includes/recycle_featured.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div id="search-row-wrapper">
      <div class="container">
        <div class="search-inner">
            <!-- Start Search box -->
              <?php include 'code/modules/quick_recycle_search.php'; ?>
            <!-- End Search box -->
        </div>
      </div>
    </div>
