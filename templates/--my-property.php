...
<?php include 'code/includes/member_properties_list.php'; ?>
<!DOCTYPE html>
<html lang="en">
  <head>
  <title>My Properties : My Dashboard : <?php echo COMPANY_NAME; ?></title> 
    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9 page-content">
            <div class="inner-box">
              <h2 class="title-2"><i class="fa fa-credit-card"></i> My Properties <a class="btn btn-danger btn-post" href="/post-property-ads"><span class="fa fa-plus-circle"></span> Upload your property<div class="ripple-container"></div></a></h2>
              <div class="table-responsive">
			  <?php $filter_options = array('PROPERTIES', 'Property', 'my-property-manage', 900, 1000); include 'code/modules/members_manage_filter.php'; ?>
