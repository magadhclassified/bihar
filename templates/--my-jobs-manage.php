<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/member_jobs_info.php'; ?><!DOCTYPE html>
<html lang="en">
  <head>
  <title>My Job: My Dashboard: <?php echo COMPANY_NAME; ?></title>
              ...
              <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseB1"> Post Your Job </a> </h4>
                  </div>
                  <div id="collapseB1" class="panel-collapse collapse in">
                    <div class="panel-body">
					
					<form method="post" action="code/includes/member_jobs_manage.php" enctype="multipart/form-data" onsubmit="return check_form(this, ['title', 'ref', 'salary', 'industry', 'commitment', 'type', 'geo1', 'geo2', 'contact_name', 'contact_number', 'contact_email'], ['TEXT', 'TEXT', 'TEXT', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'EMAIL']);">
					...
					<input placeholder="Property Title" class="form-control" type="text" name="title" value="<?php echo $item_title; ?>" />
                        ...
                        <div class="form-group is-empty">
						  ...
						  <input class="form-control" type="text" placeholder="Salary" name="salary" value="<?php echo $item_salary; ?>" />
						  <small>Numeric value only, e.g. 10000.00</small>
                        <span class="material-input"></span></div>
						
                        <div class="form-group is-empty">
                          <label class="control-label" for="Phone">Industry</label>
						  <select name="industry" class="form-control"><option value="0">&nbsp;Please Select...</option><?php echo $industries_listbox; ?></select>
						
                        <span class="material-input"></span></div>
                        <div class="form-group is-empty">
                          <label class="control-label">Commitment</label>
                         <select name="commitment" class="form-control"><option value="0">&nbsp;Please Select...</option><?php echo $commitments_listbox; ?></select>
                        <span class="material-input"></span></div>
					 ...
					 <div class="form-group is-empty">
						...
						<?php if(strlen($item_image_file1) > 0){ ?><a href="files/property/medium/<?php echo $item_image_file1; ?>" onclick="return!window.open(this.href);">Current Image</a><?php } ?>
						</div></div>
