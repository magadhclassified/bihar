<?php if(!isset($is_caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/directory_info.php'; ?><?php include 'code/includes/directory_list.php'; ?><?php include 'code/includes/directory_search_fields.php'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title><?php echo SYSTEM_NAME; ?>: Listings: Directory</title>
...
<div class="section"><div class="title_wrapper"><h2>Directory</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
...
<a href="directory/add" class="button add_new"><span><span>ADD NEW</span></span></a><br />
</p>																															
...
<div class="section"><div class="title_wrapper"><h2>Search Directory</h2><span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">
<table style="width:660px;border:0px;" cellspacing="2" cellpadding="2">
  ...
  <td>&nbsp;</td>
  <td style="text-align:right;padding-right:13px;"><input type="hidden" name="origin" value="DIRECTORY" /><input type="submit" value="Search" /></td>
  </tr>
</table>																															
</div></div></div></div></div><span class="scb"><span class="scb_left"></span><span class="scb_right"></span></span></div></div>
</form>
...
<h2>Directory<?php echo $result_title_append; ?></h2>
...
<div class="section table_section"><div class="title_wrapper"><h2>Directory<?php echo $result_title_append; ?></h2>
<span class="title_wrapper_left"></span><span class="title_wrapper_right"></span></div><div class="section_content"><div class="sct"><div class="sct_left"><div class="sct_right"><div class="sct_left"><div class="sct_right">							<div  id="product_list"><div class="table_wrapper"><div class="table_wrapper_inner">
...
<?php if($listing_form){ ?>
<form action="code/includes/directory_manage.php" class="search_form general_form" method="post" enctype="multipart/form-data" id="webdev_form" onsubmit="return check_form(this, ['title', 'cat', 'geo1', 'geo2', 'member', 'contact_email'], ['TEXT', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'LISTBOX', 'EMAIL']);">
<div class="section">
