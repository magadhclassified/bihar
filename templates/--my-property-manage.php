<?php if(!isset($caller)){exit('Direct access not allowed.');} ?><?php include 'code/includes/member_properties_info.php'; ?><!DOCTYPE html>
<html lang="en">
  <head>
  <title>My Property: My Dashboard: <?php echo COMPANY_NAME; ?></title>
              ...
              <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title"> <a data-toggle="collapse" href="#collapseB1"> Post Your Property </a> </h4>
                  </div>
                  <div id="collapseB1" class="panel-collapse collapse in">
                    <div class="panel-body">
					<form method="post" action="code/includes/member_properties_manage.php" enctype="multipart/form-data" onsubmit="return check_form(this, ['title', 'category', 'type', 'price', 'ref', 'dwelling', 'bed', 'bath', 'geo1', 'geo2', 'contact_name', 'contact_number', 'contact_email'], ['TEXT', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'TEXT', 'TEXT', 'TEXT', 'LISTBOX', 'LISTBOX', 'TEXT', 'TEXT', 'EMAIL']);">
					...
					<input placeholder="Property Title" class="form-control" type="text" name="title" value="<?php echo $item_title; ?>" />
                        ...
                        <span class="material-input"></span></div>
                        <div class="form-group is-empty">
                          <label class="control-label" for="Phone">Rental Time</label>
						  <input type="text" placeholder="Rental Time" id="rentaltime" class="form-control" name="rentaltime" value="<?php echo $item_rentaltime; ?>"  />
						  <small>Rentals only, e.g. per year</small>
                        <span class="material-input"></span></div>
						
                        <div class="form-group is-empty">
                          <label class="control-label">No. of Cheques</label>
                          <input type="text" placeholder="No. of Cheques" class="form-control" name="no_cheques" value="<?php echo $item_noCheques; ?>">
						  <small>Rentals only, number of cheques</small>
                        <span class="material-input"></span></div>
						  <div class="form-group is-empty">
                          <label class="control-label">Reference #</label>
                          <input type="text" placeholder="Reference #" class="form-control" name="ref" value="<?php echo $item_ref; ?>">
                        <span class="material-input"></span></div>
						
						  <div class="form-group is-empty">
                          <label class="control-label">Dwelling Size</label>
                          <input type="text" placeholder="Dwelling Size" class="form-control" name="dwelling" value="<?php echo $item_size_dwelling; ?>">
						  <small>Numeric value only in <?php echo $global_settings_measurements[2]; ?>, e.g. 500</small>
                        <span class="material-input"></span></div>
						
						  <div class="form-group is-empty">
                          <label class="control-label">Bedrooms</label>
                          <input type="text" placeholder="Bedrooms" class="form-control" name="bed" value="<?php echo $item_beds; ?>">
						  <small>Numeric value only, e.g. 3</small>
                        <span class="material-input"></span></div>
						
						  <div class="form-group is-empty">
                          <label class="control-label">Bathrooms</label>
                          <input type="text" placeholder="Bathrooms" class="form-control" name="bath" value="<?php echo $item_baths; ?>">
						  <small>Numeric value only, e.g. 3</small>
                        <span class="material-input"></span></div>
					 ...
					 <div class="form-group is-empty">
                        ...
                        <select name="amenity[]" multiple="multiple" size="10" class="form-control"><?php echo $amenities_list; ?></select>
						<small>CTRL + click to select multiple</small>
                        <span class="material-input"></span></div>
						
						<div class="form-group is-empty">
                          <label class="control-label">Views</label>
                          <select name="view[]" multiple="multiple" size="10" class="form-control"><?php echo $views_list; ?></select>
						  <small>CTRL + click to select multiple</small>
                        <span class="material-input"></span></div>
